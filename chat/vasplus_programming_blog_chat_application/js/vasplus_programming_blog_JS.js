...
function displayChatsOnlineUsers()
{
	$.ajax({
		...
		beforeSend: function() 
		{
			$("#display_users_online").html('<br clear="all"><center><div style="margin-top:100px;font-family:Verdana, Geneva, sans-serif; font-size:13px;" align="center">Loading <img src="vasplus_programming_blog_chat_application/smileys/loadings.gif" align="absmiddle" title="Loading..." /></div></center><br clear="all">');
		},
		success: function(response) 
		{
...
function logins() 
{
	...
	else
	{
		...
		$.ajax({
			...
			beforeSend: function() 
			{
				$("#login_status").html('<br clear="all"><div style="padding-left:60px;"><font style="font-family:Verdana, Geneva, sans-serif; font-size:13px; color:black;">Please wait</font> <img src="vasplus_programming_blog_chat_application/smileys/loadings.gif" alt="Sending...." align="absmiddle" title="Sending...."/> </div>');
			},
			success: function(response)
			{
...
function signUps() 
{
	...
	else
	{
		...
		$.ajax({
			...
			beforeSend: function() 
			{
				$("#signup_status").html('<br clear="all"><div style="padding-left:60px;"><font style="font-family:Verdana, Geneva, sans-serif; font-size:13px; color:black;">Please wait</font> <img src="vasplus_programming_blog_chat_application/smileys/loadings.gif" alt="Sending...." align="absmiddle" title="Sending...."/> </div><br clear="all">');
			},
			success: function(response)
			{
	...
	if(confirm("If you are really sure that you want to logout then click on OK otherwise, click on Cancel."))
	{
		...
		else
		{
			 ...
			 $.ajax({
				...
				beforeSend: function() 
				{
					$("#vasplus_programming_blog_chats_displayer").html('<br clear="all"><center><div style="margin-top:100px;font-family:Verdana, Geneva, sans-serif; font-size:13px;" align="center">Please wait <img src="vasplus_programming_blog_chat_application/smileys/loadings.gif" align="absmiddle" title="Loading..." /></div></center><br clear="all">');
				},
				success: function(response) 
				{
					$.cookie('fullnames', '');
...
{ 
	$('#attachedFile').live('change', function() 
	{
		$("#vasplus_programming_blog_attachmentchatform").vpbUploader({
			...
			{
				$('#vpb_chatPhoto_attached_file_status').html('&nbsp;&nbsp;<font style="font-family:Verdana, Geneva, sans-serif; font-size:13px; color:black;">Uploading</font> <img src="vasplus_programming_blog_chat_application/smileys/loadings.gif" align="absmiddle" alt="Uploading...." title="Uploading...."/>');
			},
			...
			success: function(response) 
			{
				if (response != "") 
				{
					...
					{
						$('#updated_photo_by_vasplus_programming_blog').html("<span class='nprofileimg'><a href='javascript:void(0);'><img src='vasplus_programming_blog_chat_application/photos/"+$.cookie('usernames')+".gif' alt='' title='' border='0' style='width:100px;height:90px;'></a></span>");
