    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            <a href="../../mother/registration/Sign-Up.html">
              <i class="fa fa-edit"></i> <span>Mother Registration</span>
            </a>

          </li>
          <li class="treeview">
            <a href="../../staff/allocate_mothers/index.php">
              <i class="fa fa-edit"></i> <span>Mother Appointments</span>
            </a>
        ...
        <div class="row">
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
              ...
              <div id="hidden" style="display : none;" class="inner">
                ...
                mysqli_close($conn);
                while ($row = mysqli_fetch_assoc($respond)) {
                  echo $row['num'] . " Requests for " . $row['l_name'] . " </br>";
                }
                ?>
              </div>
            </div>
            ...
            <div class="small-box bg-green">
              <div class="inner">
                <h4>
				                  <?php
                  $conn = mysqli_connect('localhost', 'root', '', 'm&bc');
                  $query = "SELECT COUNT(id) AS num FROM mother_allocation_rqst";
                  $result = mysqli_query($conn, $query);
              ...
              <div id="hidden" style="display : none;" class="inner">
                <?php
                $conn = mysqli_connect('localhost', 'root', '', 'm&bc');
                $query = "SELECT COUNT(id) AS num, mother_nic FROM `mother_allocation_rqst` group by id;";
                $respond = mysqli_query($conn, $query);
                mysqli_close($conn);
                while ($row = mysqli_fetch_assoc($respond)) {
                  echo $row['num'] . " Requests for " . $row['mother_nic'] . " </br>";
                }
                ?>			  
              </div>
            </div>
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
              ...
              <a href="pages/forms/editors.html" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div><!-- ./col -->
          <div class="col-lg-3 col-xs-6">
            <!-- small box -->
            <div class="small-box bg-red">
              ...
              <a href="../../students-site/upload/get_file.php" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div><!-- ./col -->
        </div><!-- /.row -->
        <!-- Main row -->
